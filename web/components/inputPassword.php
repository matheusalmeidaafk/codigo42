...
function renderInputPassword(array $props): void
{
    $id = htmlspecialchars($props['id'] ?? '', ENT_QUOTES, 'UTF-8');
    $name = htmlspecialchars($props['name'] ?? $id, ENT_QUOTES, 'UTF-8');
    $label = htmlspecialchars($props['label'] ?? 'Senha', ENT_QUOTES, 'UTF-8');
    $placeholder = htmlspecialchars($props['placeholder'] ?? '********', ENT_QUOTES, 'UTF-8');
    $autocomplete = htmlspecialchars($props['autocomplete'] ?? 'current-password', ENT_QUOTES, 'UTF-8');
    ...
    <div class="<?= $wrapperClass ?>">
        ...
        <div class="input-group">
            ...
            <button
                ...
                <span class="password-icon password-icon-eye">
                    <svg
                ...
                <span class="password-icon password-icon-eye-slash d-none">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
